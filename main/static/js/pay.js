var charge = document.getElementById('charge_button');
if(charge) {
    charge.addEventListener('click', function() {
        BootPay.request({
        	price: '1000', //실제 결제되는 가격
        	application_id: "5cd8557e396fa6773ebd08b2",
        	name: 'Share Point', //결제창에서 보여질 이름
        	pg: '',
        	method: '', //결제수단, 입력하지 않으면 결제수단 선택부터 화면이 시작합니다.
        	show_agree_window: 0, // 부트페이 정보 동의 창 보이기 여부
        	items: [
        		{
        			item_name: '1000 포인트', //상품명
        			qty: 1, //수량
        	...
        	user_info: {
        		username: '이준경',
        		email: 'wnsrud3611@naver.com',
        		addr: '영종도',
        		phone: '010-4055-3611'
        	},
        	order_id: 'order_id_1234', //고유 주문번호로, 생성하신 값을 보내주셔야 합니다.
        	params: {callback1: '그대로 콜백받을 변수 1'},
